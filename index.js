...
async function checkWeather(city) {
    ...
    if (data.weather[0].main == "Clouds") {
        weatherIcon.src = "Pictures/clouds.png";
          bkg.style.backgroundImage = "url(https://i.gifer.com/origin/f0/f02370a6d3911a8037dd70c0f6ef0174_w200.gif)";
    }
        ...
        weatherIcon.src = "Pictures/clear.png"
         bkg.style.backgroungImage="url('https://media2.giphy.com/media/0Styincf6K2tvfjb5Q/200w.gif?cid=6c09b952c9agj68ubrfaxuosw93186p3zsznmpjnd6rcmbuv&ep=v1_gifs_search&rid=200w.gif&ct=g')";
    }
